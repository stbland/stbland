				...
				<tbody>
					<c:forEach items="${categories}" var="category" varStatus="_st">
						<tr>
							...
							<td>
								<a href="${pageContext.request.contextPath}/domain/category/show/${category.id}" class="button button-show miniature"><fmt:message key="crud.show.button"/></a>
								<a href="${pageContext.request.contextPath}/domain/category/update/${category.id}" class="button button-edit miniature"><fmt:message key="crud.edit.button"/></a>
								<a href="${pageContext.request.contextPath}/domain/category/delete/${category.id}" class="button button-delete modal miniature"><fmt:message key="crud.delete.button"/></a>
							</td>
						</tr>
					</c:forEach>
				</tbody>
