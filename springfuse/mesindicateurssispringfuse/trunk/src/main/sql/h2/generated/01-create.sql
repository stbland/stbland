...
ALTER TABLE CATEGORIES ALTER COLUMN ID IDENTITY;
...
CREATE INDEX IF NOT EXISTS INDICATORS_FK1_INDEX_F
	ON INDICATORS (CATEGORY_ID);
ALTER TABLE INDICATORS ALTER COLUMN ID IDENTITY;

CREATE TABLE INDICATORS_TAGS (
	INDICATOR_ID INTEGER(10) not null
	,TAG_ID INTEGER(10) not null
);
CREATE INDEX IF NOT EXISTS INDICATORS_TAGS_FK1_INDEX_3
	ON INDICATORS_TAGS (INDICATOR_ID);
CREATE INDEX IF NOT EXISTS INDICATORS_TAGS_FK2_INDEX_3
	ON INDICATORS_TAGS (TAG_ID);
CREATE PRIMARY KEY 
	ON INDICATORS_TAGS (INDICATOR_ID,TAG_ID);
...
ALTER TABLE TAGS ALTER COLUMN ID IDENTITY;
...
ALTER TABLE INDICATORS_TAGS 
	ADD CONSTRAINT INDICATORS_TAGS_FK1
		FOREIGN KEY (INDICATOR_ID)
			REFERENCES INDICATORS (ID);
ALTER TABLE INDICATORS_TAGS 
	ADD CONSTRAINT INDICATORS_TAGS_FK2
		FOREIGN KEY (TAG_ID)
			REFERENCES TAGS (ID);
