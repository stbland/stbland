...
import static fr.cora.mesindicateurssi.util.ResourcesUtil.DATE_FORMAT_PATTERN;
...
@Table(name = "ACCOUNT")
@JpaUnique
public class Account implements Persistable<String>, Copyable<Account> {
    ...
    public void copyTo(Account account) {
        ...
        if (getHomeAddress() != null) {
            account.setHomeAddress(new Address(getHomeAddress().getId()));
        }
        if (getBooks() != null) {
            List<Book> books = new ArrayList<Book>();
            for (Book book : getBooks()) {
                books.add(new Book(book.getId()));
            }
            setBooks(books);
        }
        if (getDocuments() != null) {
            ...
            for (Document document : getDocuments()) {
                documents.add(new Document(document.getId()));
            }
