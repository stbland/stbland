...
@Table(name = "TAGS")
@JpaUnique
public class Tag implements Persistable<Integer>, Copyable<Tag> {
    ...
    public boolean equals(Object other) {
        return this == other || (other instanceof Tag && hashCode() == other.hashCode());
    }
    ...
    /**
     * Construct a readable string representation for this {@link Tag} instance.
     */
    @Override
