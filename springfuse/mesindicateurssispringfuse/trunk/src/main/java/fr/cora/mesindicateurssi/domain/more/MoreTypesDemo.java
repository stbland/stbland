 ...
 */
package fr.cora.mesindicateurssi.domain.more;
...
import fr.cora.mesindicateurssi.domain.Copyable;
import fr.cora.mesindicateurssi.validation.JpaUnique;

@Entity
@Table(name = "MORE_TYPES_DEMO")
@JpaUnique
public class MoreTypesDemo implements Persistable<Integer>, Copyable<MoreTypesDemo> {
