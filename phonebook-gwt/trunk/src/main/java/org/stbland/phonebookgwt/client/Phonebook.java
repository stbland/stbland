...
import org.stbland.phonebookgwt.client.widget.PersonSuggestBox;
...
public class Phonebook implements EntryPoint {
	 ...
	 * service.
	 */
	private final PhoneServiceAsync phoneService = GWT
	...
	public void onModuleLoad() {
		...
		// JSONServiceDefTarget serviceTarget = (JSONServiceDefTarget)
		// phoneService;
		...
		final PersonSuggestBox nameField = new PersonSuggestBox();
		...
		class MyHandler implements ClickHandler, KeyUpHandler {
			...
			private void sendNameToServer() {
				...
				phoneService.findPhone(textToServer,
						new AsyncCallback<PhoneDto>() {
							...
							public void onSuccess(PhoneDto phone) {
								...
								String result = "poste=" + phone.getPoste();
